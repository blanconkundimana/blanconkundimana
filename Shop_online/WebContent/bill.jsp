...
try{
	...
	while(rs.next()){
		...
		ResultSet rs2=st.executeQuery("select * from users inner join cart where cart.email='"+email+"'");
		while(rs2.next())
		{
	
%>
<h3>Online shopping Bill (BCO Days)</h3>
<hr>
...
<a href="http://127.0.0.1:5500/pa/index.html"><button class="button left-button">Pay</button></a>
