...
%>
      ...
      %>
         ...
         <%}
      ResultSet rs2=st.executeQuery("select * from users where email='"+mail+"'");
      while(rs2.next())
      {
...
<form action="addressPaymentForOrderAction.jsp" method="post">
 <div class="left-div">
 <h3>Enter Address</h3>
<input class="input-style" type="text" name="address" value="<%=rs2.getString(7) %>" placeholder="Enter Addres" required>
 </div>
